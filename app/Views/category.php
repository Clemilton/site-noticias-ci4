            ...
            <div class="col-md-9" data-aos="fade-up">
                ...
                <?php foreach ($posts as $post) : ?>
                    <div class="d-md-flex post-entry-2 half">
                        ...
                        <div>
                            <div class="post-meta"><span class="date"><?php echo $post->categoryName ?></span> <span class="mx-1">&bullet;</span> <span><?php echo date('d/m/Y', strtotime($post->created_at)) ?></span></div>
                            <h3><a href="single-post.html"><?php $post->title ?></a></h3>
